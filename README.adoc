...
****
.http://joyreactor.com/post/1646612[Tentativa e Erro: "paradigma" de programação mais usado no mundo, quando não se tem a menor idea da finalidade de determinado código.]
...
.Como fica seu código escrito usando o "paradigma" de tentativa e erro 😳. (Fonte: https://goo.gl/oheZqw[123rf.com])
...
- assim como métodos de contrução evoluem para corrigir problemas como custo, tempo de construção, qualidade e segurança, a POO surgiu para corrigir problemas de outros paradigmas de programação e suprir novas necessidades tanto dos desenvolvedores quanto dos clientes;
- etc.
